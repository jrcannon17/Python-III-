...
4000: "Axle & Driveshaft", 5200: "Exhaust", 6000 : "Engine", 7000 : "Transmission",
...
16000: "Molding & Ornaments", 17000 : "Safety Equipment (Jack, Speedometer,Washer, Wipers, Mirrors, Bumpers)",
...
part_check = {
                check(Part_Range, 5500, 5900) :
                "Rear Springs",
                check(Part_Range, 5300, 5400) :
                "Front Springs & Stabilizer",
                check(Part_Range, 18200, 18700) :
                "Comfort-Convenience Equipment (Floor Mats, Heater, etc.)",
                check(Part_Range, 19600, 19900) :
                "Air Conditioning, etc."
                }

Recall_Number = {}

string = "7L3Z-14D696-A"
print(len(string))
